...
public class FXMLdisplayprofile extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            // Load body (DisplayProfiles.fxml)
            System.out.println("Loading DisplayProfiles.fxml");
            URL bodyUrl = getClass().getResource("/MaryemFXML/DisplayProfiles.fxml");
            if (bodyUrl == null) {
                throw new IOException("Cannot find DisplayProfiles.fxml at /DisplayProfiles.fxml");
            }
            ...
            System.out.println("DisplayProfiles.fxml loaded successfully");
            ...
            primaryStage.setTitle("JavaFX Scrollable Window - List Profiles");
