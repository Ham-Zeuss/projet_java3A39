...
public class FXMLDisplayConsultations extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            // Load body (FXMLDisplayConsultations.fxml)
            System.out.println("Loading FXMLDisplayConsultations.fxml");
            URL bodyUrl = getClass().getResource("/MaryemFXML/DisplayConsultations.fxml");
            if (bodyUrl == null) {
                throw new IOException("Cannot find FXMLDisplayConsultations.fxml at /FXMLDisplayConsultations.fxml");
            }
            ...
            System.out.println("FXMLDisplayConsultations.fxml loaded successfully");
            ...
            primaryStage.setTitle("JavaFX Scrollable Window - Consultations");
